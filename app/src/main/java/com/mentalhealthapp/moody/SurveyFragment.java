    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(view1 -> {
            ...
            if (selectedId1 == -1 || selectedId2 == -1 || selectedId3 == -1 || selectedId4 == -1) {
                ...
                RadioButton answer1 = question1.findViewById(selectedId1);
                RadioButton answer2 = question2.findViewById(selectedId2);
                RadioButton answer3 = question3.findViewById(selectedId3);
                RadioButton answer4 = question4.findViewById(selectedId4);
...
//                    ref.child("Question4").setValue(answer4.getText());
    ...
    public void updateDatabase(SurveyData surveyData) {
        List<SurveyData> updateSurvey = new ArrayList<>(surveyDataList);
